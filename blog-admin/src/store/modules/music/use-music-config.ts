...
import { BLOG_ADMIN_MUSIC_CONFIG } from '@/constants'
...
export function useMusicConfig() {
	...
	const musicConfig = reactive<MusicConfig>(
		Object.assign(defaultMusicConfig, getLocalCache(BLOG_ADMIN_MUSIC_CONFIG) || {})
	)
	...
	function storageMusicConfig() {
		setLocalCache(BLOG_ADMIN_MUSIC_CONFIG, musicConfig)
	}
