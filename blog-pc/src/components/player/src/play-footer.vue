...
import { EPlayMode, EPlayFooterAction, type PlayFooterActionType, type PlayFooterConfig } from './player'
...
const props = withDefaults(defineProps<PlayFooterProps>(), {
	playConfig: () => {
		return ['play-mode', 'next', 'play', 'lyric', 'prev', 'volume', 'player-style', 'song-list', 'play-progress']
	}
})
	...
	<div class="footer-box">
		<div class="info">
			<div class="cover">
				...
				<span
					v-else
					class="iconfont icon-listen-music"></span>
				<div class="cover-mask">
					<slot name="coverMask"></slot>
				</div>
			</div>
			<div class="text">
		...
		<div class="controller">
			...
			<div
				v-if="isShowConfig('play-progress')"
				class="progress-wrap">
		...
		<div class="actions">
			...
			<div
				...
				v-if="isShowConfig('player-style')"
				title="播放器风格"
				class="action-item">
